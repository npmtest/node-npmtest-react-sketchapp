...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/components/Image.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/components/Image.js</span></h1>
    <h2>
        
        Statements: <span class="metric">67.69% <small>(44 / 65)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">30.61% <small>(15 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">54.55% <small>(6 / 11)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">76.47% <small>(26 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/components/</a> &#187; Image.js</div>
</div>
<div class="body">
...
&nbsp;
var ImageURISourcePropType = _react.PropTypes.shape({
  uri: _react.PropTypes.string.isRequired,
  height: _react.PropTypes.number,
  width: _react.PropTypes.number
});
&nbsp;
var ImageSourcePropType = _react.PropTypes.oneOfType([ImageURISourcePropType,
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Image() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Image);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Image.__proto__ || Object.getPrototypeOf(Image)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(Image, [{
    key: 'render',
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var style = _stylesheet2.default.flatten(this.props.style) || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var sketchResizeMode = ResizeModes[resizeMode || style &amp;&amp; style.resizeMode || 'cover'];</span>
<span class="cstat-no" title="statement not covered" >      if (source &amp;&amp; typeof source !== 'string') {</span>
<span class="cstat-no" title="statement not covered" >        style = _extends({</span>
