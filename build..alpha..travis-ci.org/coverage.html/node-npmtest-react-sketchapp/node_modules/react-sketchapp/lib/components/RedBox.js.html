...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/components/RedBox.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/components/RedBox.js</span></h1>
    <h2>
        
        Statements: <span class="metric">64.62% <small>(42 / 65)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/components/</a> &#187; RedBox.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function RedBox() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, RedBox);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (RedBox.__proto__ || Object.getPrototypeOf(RedBox)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(RedBox, [{
    key: 'renderFrames',
    value: <span class="fstat-no" title="function not covered" >function renderFrames(frames) {</span>
<span class="cstat-no" title="statement not covered" >      return frames.map(<span class="fstat-no" title="function not covered" >function (f, index) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      var error = this.props.error;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var frames = void 0;</span>
<span class="cstat-no" title="statement not covered" >      var parseError = void 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var frameChildren = void 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        frames = _errorStackParser2.default.parse(error);</span>
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        parseError = new Error('Failed to parse stack trace. Stack trace information unavailable.');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (parseError) {</span>
<span class="cstat-no" title="statement not covered" >        frameChildren = _react2.default.createElement(</span>
          _View2.default,
...
<span class="cstat-no" title="statement not covered" >        frameChildren = this.renderFrames(frames);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(</span>
        _View2.default,
