...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/wrappers/sharedTextStyles.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/wrappers/sharedTextStyles.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/wrappers/</a> &#187; sharedTextStyles.js</div>
</div>
<div class="body">
...
&nbsp;
  _createClass(TextStyles, [{
    key: 'setContext',
    value: <span class="fstat-no" title="function not covered" >function setContext(context) {</span>
<span class="cstat-no" title="statement not covered" >      (0, _invariant2.default)(context, 'Please provide a context');</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return this;</span>
    ...
    key: 'setStyles',
    value: <span class="fstat-no" title="function not covered" >function setStyles(styles) {</span>
<span class="cstat-no" title="statement not covered" >      (0, _invariant2.default)(this._context, 'Please provide a context');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._context.document.documentData().layerTextStyles().setObjects(styles);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
  }, {
    key: 'addStyle',
    value: <span class="fstat-no" title="function not covered" >function addStyle(name, style) {</span>
<span class="cstat-no" title="statement not covered" >      (0, _invariant2.default)(this._context, 'Please provide a context');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var textStyle = (0, _sketchappJsonPlugin.fromSJSONDictionary)(style);</span>
&nbsp;
      // Flow doesn't pick up invariant truthies
<span class="cstat-no" title="statement not covered" >      var context = this._context;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var s = context.document.documentData().layerTextStyles().addSharedStyleWithName_firstInstance(name, textStyle);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return s.objectID();</span>
    }
  }]);
&nbsp;
  return TextStyles;
