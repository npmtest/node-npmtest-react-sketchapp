...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/renderers/ArtboardRenderer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/renderers/ArtboardRenderer.js</span></h1>
    <h2>
        
        Statements: <span class="metric">71.11% <small>(32 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">35.9% <small>(14 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/renderers/</a> &#187; ArtboardRenderer.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ArtboardRenderer() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, ArtboardRenderer);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (ArtboardRenderer.__proto__ || Object.getPrototypeOf(ArtboardRenderer)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(ArtboardRenderer, [{
    key: 'renderGroupLayer',
    value: <span class="fstat-no" title="function not covered" >function renderGroupLayer(layout, style, textStyle, props,</span>
    // eslint-disable-next-line no-unused-vars
    value) {
<span class="cstat-no" title="statement not covered" >      var color = void 0;</span>
<span class="cstat-no" title="statement not covered" >      if (style.backgroundColor !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >        color = (0, _models.makeColorFromCSS)(style.backgroundColor);</span>
      }
&nbsp;
