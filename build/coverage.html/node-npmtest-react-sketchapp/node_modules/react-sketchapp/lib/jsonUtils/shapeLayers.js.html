...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/jsonUtils/shapeLayers.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/jsonUtils/shapeLayers.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-sketchapp/node_modules/react-sketchapp/lib/jsonUtils/</a> &#187; shapeLayers.js</div>
</div>
<div class="body">
...
&nbsp;
var makeHorizontalPath = exports.makeHorizontalPath = <span class="fstat-no" title="function not covered" >function makeHorizontalPath() {</span>
...
&nbsp;
var makeVerticalPath = exports.makeVerticalPath = <span class="fstat-no" title="function not covered" >function makeVerticalPath() {</span>
<span class="cstat-no" title="statement not covered" >  return {</span>
    _class: 'path',
    isClosed: false,
    points: [{
...
&nbsp;
var makeRectPath = exports.makeRectPath = <span class="fstat-no" title="function not covered" >function makeRectPath() {</span>
<span class="cstat-no" title="statement not covered" >  var radii = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : [0, 0, 0, 0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var _radii = _slicedToArray(radii, 4),</span>
      r0 = _radii[0],
      r1 = _radii[1],
      r2 = _radii[2],
      r3 = _radii[3];
...
&nbsp;
var makeShapePath = exports.makeShapePath = <span class="fstat-no" title="function not covered" >function makeShapePath(frame, path) {</span>
<span class="cstat-no" title="statement not covered" >  return {</span>
    _class: 'shapePath',
    frame: frame,
...
&nbsp;
var makeRectShapeLayer = exports.makeRectShapeLayer = <span class="fstat-no" title="function not covered" >function makeRectShapeLayer(x, y, width, height) {</span>
<span class="cstat-no" title="statement not covered" >  var radii = arguments.length &gt; 4 &amp;&amp; arguments[4] !== undefined ? arguments[4] : [0, 0, 0, 0];</span>
<span class="cstat-no" title="statement not covered" >  return {</span>
    _class: 'rectangle',
    do_objectID: (0, _models.generateID)(),
...
&nbsp;
var makeShapeGroup = exports.makeShapeGroup = <span class="fstat-no" title="function not covered" >function makeShapeGroup(frame) {</span>
<span class="cstat-no" title="statement not covered" >  var layers = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : [];</span>
<span class="cstat-no" title="statement not covered" >  var fills = arguments.length &gt; 2 &amp;&amp; arguments[2] !== undefined ? arguments[2] : [];</span>
<span class="cstat-no" title="statement not covered" >  return {</span>
    _class: 'shapeGroup',
    do_objectID: (0, _models.generateID)(),
    frame: frame,
